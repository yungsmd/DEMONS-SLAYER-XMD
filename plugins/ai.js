...
module.exports = [
 {
  ...
  operate: async ({ m, reply, text }) => {
    ...
    try {
      ...
      console.error('Error fetching response from JINWOO-Ai API:', error);
      reply("An error occurred while fetching the response from JinwooAI API.");
    }
  }
},
{
...
},
{
  ...
  operate: async ({ m, reply, text }) => {
    ...
    try {
      ...
      console.error('Error fetching response from MALVIN AI API:', error);
      reply("An error occurred while fetching the response from MALVIN AI API.");
    }
  }
},
 {
