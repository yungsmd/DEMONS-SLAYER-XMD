gimport moment from 'moment-timezone';
import fs from 'fs';
import os from 'os';
...
const cmd = m.body.startsWith(prefix) ? m.body.slice(prefix.length).split(' ')[0].toLowerCase() : '';
       ...
       const pref = config.PREFIX;
        ...
        const validCommands = ['list3', 'help', 'menu1'];
...
╰─────────────━┈⊷ `
            ...
            header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image : fs.readFileSync('./media/slayer.jpg')}, { upload: Matrix.waUploadToServer})), 
                  title: ``,
                  gifPlayback: true,
                  subtitle: "",
