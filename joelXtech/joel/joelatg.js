...
const text = m.body.slice(prefix.length + cmd.length).trim();
    ...
    if (!m.isGroup) return m.reply("*ᴛʜɪs ᴏs ǫ ɢʀᴏᴜᴘ ᴄᴏᴍᴍᴀɴᴅ}*");
    ...
    if (!botAdmin) return m.reply("*sʟᴀʏᴇʀ ᴍᴜsᴛ ʙᴇ ᴀᴅᴍɪɴ*");
    if (!senderAdmin) return m.reply("*ʏᴏᴜ ᴍᴜsᴛ ʙᴇ ᴀᴅᴍɪɴ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ*");
